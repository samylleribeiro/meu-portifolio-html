...
const MeusProjetos =[
    ...
    {   titulo:"Orações 📖 📿",
        descricao:"Uma nova versão do projeto de orações com responsividade para celular,opção de modo noturno e uso de select para escolher a oração em vez de um botão para cada oração." ,
        link:"https://samylleribeiro.github.io/oracoes-2.0/",
    },
